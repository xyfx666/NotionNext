...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'REANickname', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '这是一个简介', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.rgsports.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'rgsports, rgsport', // 网站关键词 英文逗号隔开
